...
const getProductsByCollectionHandle = async (options) => {
...
const $$BaseLayout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const defaultDesc = "KIOSK - Things from Places";
...
const $$Collection = createComponent(async ($$result, $$props, $$slots) => {
  ...
  <div class="container py-16 sm:py-20">
    <h2 class="sr-only">Products from Collection</h2>
...
}, "/Users/mimecine/Projects/kastro/src/components/Collection.astro");
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": title }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "Collection", $$Collection, { "products": products })}` })}`;
}, "/Users/mimecine/Projects/kastro/src/pages/index.astro");

const $$file$3 = "/Users/mimecine/Projects/kastro/src/pages/index.astro";
const $$url$3 = "";
...
const $$$1 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const headers = Astro2.request.headers;
  const ip = headers.get("x-vercel-forwarded-for") || Astro2.clientAddress;
  const product = await getProductByHandle({ handle: collectionhandle || "", buyerIP: ip });
  if (!product) {
    Astro2.response.status = 404;
  }
...
}, "/Users/mimecine/Projects/kastro/src/pages/collection/[...collectionhandle].astro");

const $$file$2 = "/Users/mimecine/Projects/kastro/src/pages/collection/[...collectionhandle].astro";
const $$url$2 = "/collection/[...collectionhandle]";
